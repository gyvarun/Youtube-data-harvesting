...
# Define Session state to Get data button
   ...
   if Get_data or st.session_state.Get_state:
        ...
        api_version = 'v3'
        api_key = 'AIzaSyBW_Uk30rl7x0qq4WsXd40DZXv-Fzcqu0w'
...
# Q3
        ...
        with col2:
            ...
            if view:
                ...
                sns.set_theme(style='whitegrid', palette='deep', font='sans-serif', font_scale=1.5, color_codes = True, rc=None)
                ax1 = sns.barplot(x = 'Video Name', y = 'View count',data = df3, palette="Set2", estimator="sum", errorbar=None)
    ...
    # Q7
        ...
        with col2:
            ...
            if view:
                ...
                sns.set_theme(style='whitegrid', palette='deep', font='sans-serif', font_scale=1.5, color_codes = True, rc=None)
                ax2 = sns.barplot(x = 'Channel Name',y = 'Total number of views',data = df7, palette="Set3", estimator="sum", errorbar=None)
